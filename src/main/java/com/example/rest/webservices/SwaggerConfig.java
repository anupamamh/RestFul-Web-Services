...
public class SwaggerConfig {
	public static final Contact DEFAULT_CONTACT = new Contact("Name", "Website", "EMail ID");
	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Social Media API Title", "Social Media API Description",
